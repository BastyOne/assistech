 ...
 Future<void> _registrarEstudiante() async {
  ...
  if (permission == LocationPermission.denied) {
    ...
    GeoFenceArea ucmGeoFenceArea = GeoFenceArea(
      latitude: -35.8698344, // reemplaza con la latitud de tu geofence
      longitude: -71.5968006, // reemplaza con la longitud de tu geofence
      radius: 10.0, // reemplaza con el radio de tu geofence en metros
    );
